            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Image'); ?> (Ảnh hiển thị mobile tỉ lệ 1:1)</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Background image'); ?> (Ảnh hiển thị desktop tỉ lệ 2:1)</label>
                      <div class="input-group">
                        <span class="input-group-btn">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\phanlong\resources\views/admin/pages/block_contents/create.blade.php ENDPATH**/ ?>
                    ...
                    <div class="form-group">
                      ...
                      <div id="og_image-holder" style="margin-top:15px;max-height:150px;">
                        <?php if(isset($detail->json_params->og_image) && $detail->json_params->og_image != ''): ?>
                          <img style="height: 10rem;" src="<?php echo e($detail->json_params->og_image); ?>">
                        <?php endif; ?>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <ul class="checkbox_list" id="block_selected">
                      <?php $__currentLoopData = $block_selected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="cursor">
                          <input name="json_params[block_content][]" type="checkbox" value="<?php echo e($item->id); ?>"
                            class="mr-15 block_item cursor" id="block_content_<?php echo e($item->id); ?>" checked
                            autocomplete="off">
                          <label class="cursor" for="block_content_<?php echo e($item->id); ?>">
                    ...
                    <ul class="checkbox_list" id="block_available">
                      <?php $__currentLoopData = $blockContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!in_array($item->id, $detail->json_params->block_content ?? [])): ?>
                          <li class="cursor">
                            <input name="json_params[block_content][]" type="checkbox" value="<?php echo e($item->id); ?>"
                              class="mr-15 block_item cursor" id="block_content_<?php echo e($item->id); ?>"
                              autocomplete="off">
                            <label class="cursor" for="block_content_<?php echo e($item->id); ?>">
                              <strong><?php echo e(__($item->title) . ' (' . $item->block_name . ')'); ?></strong>
                            </label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\phanlong\resources\views/admin/pages/pages/edit.blade.php ENDPATH**/ ?>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Department'); ?> <small class="text-red">*</small></label>
                        ...
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($item->parent_id == 0 || $item->parent_id == null): ?>
                            <option value="<?php echo e($item->id); ?>"
                              <?php echo e(isset($detail->department_id) && $detail->department_id == $item->id ? 'selected' : ''); ?>>
                              <?php echo e($item->title); ?></option>

                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($item->id == $sub->parent_id): ?>
                                <option value="<?php echo e($sub->id); ?>"
                                  <?php echo e(isset($detail->department_id) && $detail->department_id == $sub->id ? 'selected' : ''); ?>>
                                  - - <?php echo e($sub->title); ?>

                                </option>

                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($sub->id == $sub_child->parent_id): ?>
                                    <option value="<?php echo e($sub_child->id); ?>"
                                      <?php echo e(isset($detail->department_id) && $detail->department_id == $sub_child->id ? 'selected' : ''); ?>>
                                      - - - -
                      ...
                      <select id="doctor_id" name="doctor_id" class="form-control select2" style="width:100%" required>
                        ...
                        <?php if(isset($doctors)): ?>
                          <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>" <?php echo e($detail->doctor_id == $item->id ? 'selected' : ''); ?>>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" name="booking_date"
                        placeholder="<?php echo app('translator')->get('Booking date'); ?>"
                        value="<?php echo e(isset($detail->booking_date) ? \Carbon\Carbon::parse($detail->booking_date)->format('d/m/Y') : ''); ?>" required>
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control timepicker" name="booking_time"
                          placeholder="<?php echo app('translator')->get('Booking time'); ?>" value="<?php echo e($detail->booking_time ?? old('booking_time')); ?>" autocomplete="off">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\phanlong\resources\views/admin/pages/bookings/edit.blade.php ENDPATH**/ ?>
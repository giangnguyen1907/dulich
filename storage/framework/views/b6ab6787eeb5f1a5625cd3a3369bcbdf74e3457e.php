            ...
            <ul class="nav nav-tabs">
              ...
              <li>
                <a href="#tab_3" data-toggle="tab">
                  <h5><?php echo app('translator')->get('Related Services'); ?></h5>
                </a>
              </li>
      ...
      $(document).on('click', '.btn_search', function() {
        ...
        $.ajax({
          ...
          data: {
            ...
            is_type: "<?php echo e(App\Consts::POST_TYPE['service']); ?>"
          },
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\phanlong\resources\views/admin/pages/cms_services/create.blade.php ENDPATH**/ ?>
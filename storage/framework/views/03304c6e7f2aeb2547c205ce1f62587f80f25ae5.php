      ...
      <div id="col-1030178715" class="col medium-3 small-12 large-3">
        <div class="col-inner text-center">
          ...
          <div class="box has-hover   has-hover box-overlay dark box-text-bottom">
            ...
            <div class="box-image">
              <div class="">
                <img width="2560" height="1707" src="<?php echo e($image); ?>" class="attachment- size-" alt="" decoding="async" loading="lazy"  />
            ...
            <div class="box-text text-center">
              <div class="box-text-inner">
                ...
                <div id="text-3410438327" class="text">
                  ...
                  <p><?php echo e(Str::limit($title, 80)); ?></p>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\phanlong\resources\views/frontend/blocks/cms_post/styles/default.blade.php ENDPATH**/ ?>
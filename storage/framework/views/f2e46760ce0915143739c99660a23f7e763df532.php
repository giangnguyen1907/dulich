                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <?php
                        $url_mapping = App\Helpers::generateRoute(App\Consts::TAXONOMY['post'], $row->title, $row->id, 'detail');
                      ?>
                      <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\phanlong\resources\views/admin/pages/cms_posts/index.blade.php ENDPATH**/ ?>
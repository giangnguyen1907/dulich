                      ...
                      <div class="row">
                        <div class="col-xs-6">
                          ...
                          <input type="text" class="form-control" name="gia_ve"
                            placeholder="<?php echo app('translator')->get('Price'); ?>" value="<?php echo e(old('gia_ve')); ?>">
                        </div>
                        <div class="col-xs-6">
                          <label><?php echo app('translator')->get('Giá xe'); ?></label>
                          <input type="text" class="form-control" name="gia_xe"
                            placeholder="<?php echo app('translator')->get('Price Car'); ?>" value="<?php echo e(old('gia_xe')); ?>">
                        </div>
                        <div class="col-xs-6">
                          <label><?php echo app('translator')->get('Giá Hướng dẫn viên'); ?></label>
                          <input type="text" class="form-control" name="gia_hdvien"
                            placeholder="<?php echo app('translator')->get('Giá hướng dẫn viên'); ?>" value="<?php echo e(old('gia_hdvien')); ?>">
                        </div>
                        <div class="col-xs-6">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp74\htdocs\dulich\resources\views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>
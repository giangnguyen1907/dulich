      ...
      <div class="box-body">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="module_code" placeholder="<?php echo app('translator')->get('module_code'); ?>" value="<?php echo e(old('module_code')); ?>"
              required>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\phanlong\resources\views/admin/pages/modules/create.blade.php ENDPATH**/ ?>
            ...
            <div class="single-product">
              <div class="product">
                <div class="row gutter-40">
                  ...
                  <div class="col-md-6 product-desc">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="product-price">
                        <?php if(isset($detail->json_params->price_old) && $detail->json_params->price_old > 0): ?>
                          <del>
                            <?php echo e(number_format($detail->json_params->price_old, 0, ',', '.')); ?>
                  ...
                  <div class="col-12 mt-5" id="content-detail">
                            ...
                            <?php $__currentLoopData = $detail->json_params->gallery_video; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($item->source != ''): ?>
                                <?php if(Str::contains($item->source, 'youtu.be') || Str::contains($item->source, 'youtube.com')): ?>
                                  ...
                                  ?>
                                  <p class="pt-3">
                                    <iframe title="<?php echo e($item->title ?? ''); ?>" width="100%" height="50"
                                      src="<?php echo e($video_code); ?>" frameborder="0"
                      ...
                      <div class="product">
                        ...
                        <div class="product-desc center">
                          <div class="product-title">
                            ...
                            <?php if(isset($item->json_params->promotion)): ?>
                              <p>
                                <?php echo $item->json_params->promotion; ?>

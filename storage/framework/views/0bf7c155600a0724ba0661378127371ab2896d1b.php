      ...
      <form action="<?php echo e(route(Request::segment(2) . '.index')); ?>" method="GET">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label><?php echo app('translator')->get('Tour'); ?></label>
                <select name="tour_id"  class="form-control select2" style="width: 100%;">
                  ...
                  <?php $__currentLoopData = $tour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($item->id); ?>"
                        <?php echo e(isset($params['tour_id']) && $params['tour_id'] == $item->id ? 'selected' : ''); ?>>
          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                ...
                <th><?php echo app('translator')->get('Tour'); ?></th>
                <th><?php echo app('translator')->get('Ngày đặt'); ?></th>
                <th><?php echo app('translator')->get('Giờ đặt'); ?></th>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\phanlong\resources\views/admin/pages/bookings/index.blade.php ENDPATH**/ ?>
									...
									<div id="col-1207968441" class="col medium-6 small-12 large-6">
										<div class="col-inner">
											<div class="img has-hover x md-x lg-x y md-y lg-y" id="image_111795914">
												<div class="img-inner dark">
													<img width="604" height="588" src="{{ $image }}" class="attachment-large size-large" alt="" decoding="async" loading="lazy" />
												</div>
											...
											<div class="danhgia-tour">
												...
												<div class="nguoidungdanhgia">
													...
													<div class="thongtin-tacgia">
														...
														<span class="{{ $fb->rate >=1 ? 'saodanhgia' : '' }}">✭</span><span class="{{ $fb->rate >=2 ? 'saodanhgia' : '' }}">✭</span><span class="{{ $fb->rate >=3 ? 'saodanhgia' : '' }}">✭</span><span class="{{ $fb->rate >=4 ? 'saodanhgia' : '' }}">✭</span><span class="{{ $fb->rate >=5 ? 'saodanhgia' : '' }}">✭</span>
													</div>
												</div>

												<div class="noidungdanhgia">{{ $fb->content }}</div>
									...
									<div id="col-111112" class="col medium-6 small-12 large-6">
										<div class="col-inner">
											<div class="header-form">
												...
												<div class="nhapsosao">
													<a class="danhgiasao" onclick="chonDanhGia({{$tour_id}},1)" id="danhgia{{$tour_id}}-1">✭</a>
													<a class="danhgiasao" onclick="chonDanhGia({{$tour_id}},2)" id="danhgia{{$tour_id}}-2">✭</a>
													<a class="danhgiasao" onclick="chonDanhGia({{$tour_id}},3)" id="danhgia{{$tour_id}}-3">✭</a>
													<a class="danhgiasao" onclick="chonDanhGia({{$tour_id}},4)" id="danhgia{{$tour_id}}-4">✭</a>
													<a class="danhgiasao" onclick="chonDanhGia({{$tour_id}},5)" id="danhgia{{$tour_id}}-5">✭</a>
												</div>
											</div>

											<div style="clear: both;"></div>
											<div class="frm_forms  with_frm_style frm_style_formidable-style" id="frm_form_1_container">
												<form enctype="multipart/form-data" action="{{ route('frontend.feedback') }}" method="post" class="frm-show-form " id="form_contact-form">
													@csrf
													<input type="hidden" name="tour_id" value="{{$tour_id}}">
													<input type="hidden" id="sosao_{{$tour_id}}" name="rate" value="5">
													<div class="frm_form_fields ">
														<fieldset>

                  ...
                  <div class="col-md-6 product-desc">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="product-price">
                        @if (isset($detail->json_params->price_old) && $detail->json_params->price_old > 0)
                          <del>
                            {{ number_format($detail->json_params->price_old, 0, ',', '.') }}
                          </del>
                        @endif
                            ...
                            @foreach ($detail->json_params->gallery_video as $key => $item)
                              @if ($item->source != '')
                                @if (Str::contains($item->source, 'youtu.be') || Str::contains($item->source, 'youtube.com'))
                                  ...
                                  @endphp
                                  <p class="pt-3">
                                    <iframe title="{{ $item->title ?? '' }}" width="100%" height="50"
                                      src="{{ $video_code }}" frameborder="0"

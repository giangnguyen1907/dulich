        ...
        <div id="masthead" class="header-main nav-dark toggle-nav-dark">
          <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
            ...
            <div id="logo" class="flex-col logo">
              ...
              <!-- Header logo -->
              <a href="{{ route('frontend.home') }}" title="DU LỊCH HOANG LIEN" rel="home">
                <img width="228" height="228" src="{{ $web_information->image->logo_header ?? '' }}" class="header_logo header-logo" alt="DU LỊCH HOANG LIEN" /><img width="228" height="228" src="{{ $web_information->image->logo_header ?? '' }}" class="header-logo-dark" alt="DU LỊCH HOANG LIEN" /></a>
            </div>

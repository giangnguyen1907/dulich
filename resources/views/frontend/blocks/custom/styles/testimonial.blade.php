          ...
          <div id="col-486113640" class="col small-12 large-12">
            <div class="col-inner" style="background-color:rgb(240, 240, 240);">
              ...
              <div class="box has-hover   has-hover box-overlay dark box-text-bottom">
                ...
                <div class="box-image">
                  <div class="">
                    <img width="944" height="400" src="{{ $item->image }}" class="attachment- size-" alt="" decoding="async" loading="lazy" />
              ...
              <div class="row rowbaoton" id="row-826309923">
                ...
                <div id="col-654456256" class="col medium-10 small-9 large-10">
                  <div class="col-inner text-left">
                    ...
                    <a class="button primary" href="{{ $alias }}">
                  ...
                  <div class="col-inner">
                    ...
                    <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_2033116851">
                      <div class="img-inner dark">
                        <img width="501" height="800" src="{{ $item->image_thumb }}" class="attachment-large size-large" alt="" decoding="async" loading="lazy" />
                      </div>

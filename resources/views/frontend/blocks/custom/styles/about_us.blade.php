            ...
            <div class="row row-small row-full-width align-middle" id="row-617906349">
              ...
              <div id="col-1476007435" class="col medium-6 small-12 large-6">
                <div class="col-inner">
                  ...
                  <a class="button primary" href="{{ $url_link }}">
                ...
                <div class="col-inner">
                  ...
                  <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_573773397">
                    <div class="img-inner dark">
                      <img width="978" height="400" src="{{ $image }}" class="attachment-large size-large" alt="" decoding="async" loading="lazy" sizes="(max-width: 978px) 100vw, 978px" />
                    </div>
